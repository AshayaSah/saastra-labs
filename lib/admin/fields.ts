...
export const RESOURCES: ResourceMeta[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "avatar", label: "Author photo", type: "image", full: true },
  ...
  },
  {
    ...
    label: "Page sections",
    singular: "section",
    description: "Hero + narrative blocks for the About, Team and Careers pages.",
    titleField: "heading",
    fields: [
      {
        name: "page",
  ...
  },
  {
    ...
    label: "Company stats",
    singular: "stat",
    description: "The numbers shown on the About page.",
    titleField: "label",
    fields: [
      { name: "value", label: "Value", type: "text", placeholder: "100+" },
  ...
  },
  {
    ...
    singular: "value",
    description: "Value cards shown on the About and Careers pages.",
    titleField: "title",
    fields: [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "applyHref", label: "Apply link", type: "text", placeholder: "/contact" },
      { name: "description", label: "Description", type: "textarea" },
    ],
  },
  {
