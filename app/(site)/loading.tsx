    ...
    <div className="bg-sl-bg min-h-screen">
      ...
      <div className="bg-sl-dark min-h-[70vh] flex items-center">
        <div className="sl-container w-full pt-40">
          <Skeleton className="h-6 w-44 rounded-pill bg-sl-text-inv/10" />
          <Skeleton className="mt-8 h-12 w-3/4 bg-sl-text-inv/10" />
          <Skeleton className="mt-4 h-12 w-2/3 bg-sl-text-inv/10" />
          <Skeleton className="mt-8 h-11 w-48 rounded-lg bg-sl-text-inv/10" />
        </div>
      </div>
