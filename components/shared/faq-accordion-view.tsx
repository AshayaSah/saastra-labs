      ...
      <div className="sl-container sl-section">
        <div className="grid grid-cols-1 gap-8 items-start md:gap-12 md:grid-cols-[0.9fr_1.2fr]">
          ...
          <div>
            ...
            <div className="bg-sl-surface-dark rounded-card p-6 text-sl-text-inv">
              <h3 className="m-0 mb-2.5 text-[17px] font-semibold leading-[1.3]">
                Need a fast-moving team of engineers for your startup?
              </h3>
              <p className="mt-0 mb-4.5 text-[13px] leading-[1.5] text-sl-subtle-inv">
          ...
          <div>
            {items.map((f, i) => (
              <div key={i} className="border-b border-sl-border-strong">
                <button
                ...
                >
                  <p className="mt-0 mb-4.5 text-[14px] leading-[1.6] text-sl-muted max-w-[90%]">
                    {f.answer}
                  </p>
                </div>
              </div>
