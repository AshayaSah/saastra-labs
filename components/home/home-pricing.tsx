  ...
  return (
    <section>
      <div className="sl-container sl-section">
        ...
        <div className="grid grid-cols-1 gap-3.5 mb-3.5 md:grid-cols-2">
          {/* Composable — light */}
          <BentoCard className="sl-reveal sl-d1 p-6.5">
            ...
            <p className="mt-0 mb-4.5 text-[13px] text-sl-subtle">{composable.description}</p>
            <div className="flex items-baseline gap-1 mb-4.5">
            ...
            <a href="#" className="sl-focus-ring block text-center sl-btn mb-4.5">Select plan</a>
          ...
          <BentoCard dark className="sl-reveal sl-d2 p-6.5 relative overflow-hidden text-sl-text-inv">
            ...
            <p className="relative mt-0 mb-4.5 text-[13px] text-sl-muted-inv">{scale.description}</p>
            <div className="relative flex items-baseline gap-1 mb-4.5">
            ...
            <a href="#" className="sl-focus-ring relative block text-center sl-btn mb-4.5">Select plan</a>
        ...
        <BentoCard className="sl-reveal grid grid-cols-1 items-center gap-[30px] p-6.5 md:grid-cols-[1fr_1.2fr]">
          <div>
            ...
            <p className="mt-0 mb-4.5 text-[13px] text-sl-subtle">{multiPage.description}</p>
            <div className="flex items-baseline gap-1 mb-4.5">
              <span className="text-[34px] font-bold tracking-[-0.03em]">${multiPage.monthlyPrice.toLocaleString()}</span>
              <span className="text-[13px] text-sl-subtle">/mo</span>
            </div>
            <a href="#" className="sl-focus-ring sl-btn-wide">Select plan</a>
          </div>
          <div className="grid grid-cols-2 gap-x-4.5 gap-y-2">
            {multiPage.features.map((f, i) => (
              <div key={i} className="flex items-center gap-2.5 text-[13px] text-sl-body py-1.5">
                <span className="text-sl-green">✓</span>{f}
              </div>
            ))}
          </div>
