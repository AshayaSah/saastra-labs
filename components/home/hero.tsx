  ...
  return (
    <section className="relative bg-sl-dark overflow-hidden min-h-screen flex flex-col">
      ...
      <div
        ...
        style={{ background: "radial-gradient(120% 80% at 50% -10%, transparent 55%, rgba(0,0,0,.6) 100%)" }}
      />
      ...
      <div className="sl-container relative z-10 flex flex-1 flex-col justify-between">
        <div className="pt-32 md:pt-42 lg:pt-56">
          {/* Badge pill */}
          <a href="#" className="flex w-fit rounded-full bg-neutral-900 p-1 shadow-lg shadow-black/40">
            <div className="flex items-center gap-1 sm:gap-2">
              <div className="rounded-full bg-sl-accent text-sl-accent-ink px-2 py-1 text-[10px] sm:text-xs font-semibold">
                New
              </div>
              <div className="text-sl-text-inv rounded-full pr-2 text-[10px] sm:text-xs">
          ...
          <div className="mt-6 flex flex-col items-start gap-6 md:mt-10 lg:flex-row lg:gap-10">
            <h1 className="text-sl-text-inv tracking-[-0.04em] text-3xl font-semibold text-balance sm:text-4xl md:text-5xl lg:text-7xl">
        ...
        <div className="relative h-18 sm:h-48 md:h-72">
          <p className="absolute -top-10 left-1/2 -translate-x-1/2 text-center font-semibold tracking-[-0.04em] text-transparent bg-clip-text bg-linear-to-r from-white/10 to-transparent text-[100px] select-none sm:text-[6rem] md:-top-6 md:mt-10 md:text-[160px] lg:-top-18 lg:text-[300px]">
            Saastra
          </p>
        </div>
      </div>
